...
// in simulator we redefine to format for TitanTricks Developer console
...
{\
	NSString * exceptionName = [@"org.titantricks." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.titantricks";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITitanTricksNativeItemNone = -1, 
	UITitanTricksNativeItemSpinner = -2,
	UITitanTricksNativeItemProgressBar = -3,
	
	UITitanTricksNativeItemSlider = -4,
	UITitanTricksNativeItemSwitch = -5,
	UITitanTricksNativeItemMultiButton = -6,
	UITitanTricksNativeItemSegmented = -7,
	
	UITitanTricksNativeItemTextView = -8,
	UITitanTricksNativeItemTextField = -9,
	UITitanTricksNativeItemSearchBar = -10,
	
	UITitanTricksNativeItemPicker = -11,
	UITitanTricksNativeItemDatePicker = -12,
	
	UITitanTricksNativeItemInfoLight = -13,
	UITitanTricksNativeItemInfoDark = -14,
	
	UITitanTricksNativeItemDisclosure = -15,
	
	UITitanTricksNativeItemContactAdd = -16
};
