...
//@interface TitanTricksObject : NSObject
//@end

@interface TitanTricksObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TitanTricksObject class]])
		{
			for (NSString *key in [[(TitanTricksObject*)o modules] allKeys])
			{
