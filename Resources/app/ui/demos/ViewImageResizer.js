...
(function(){
			...
			Titanium.Media.openPhotoGallery({
				...
				{	
					...
					if(Ti.Platform.osname !== 'android'){
						...
						imageResized = TitanTricks.ui.createImageResizer(evt.media);
						...
						lblSize.text = "Sorry, this demo does not work on Android. But you can use ImageResizer component.";
					}	
				},
				cancel:function()
				{
	...
	var demoInfo = {
		...
		ios:			true,
		android:		false,
		createView: 	App.ui.demos.createViewImageResizer
	}
